require("lazy").setup({
  ...
  { "stevearc/conform.nvim", event = { "BufReadPre", "BufNewFile" }, opts = { formatters_by_ft = { lua = { "stylua" }, python = { "ruff_organize_imports", "ruff_format" }, javascript = { "prettierd", "prettier" }, typescript = { "prettierd", "prettier" }, json = { "prettierd", "prettier" }, yaml = { "prettierd", "prettier" }, markdown = { "prettierd", "prettier" }, rust = { "rustfmt" } }, format_on_save = { timeout_ms = 500 } } },
